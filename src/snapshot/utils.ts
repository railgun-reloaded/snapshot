export function maxBigInts (a: bigint, b: bigint) { return a > b ? a : b }
export function minBigInts (a: bigint, b: bigint) { return a < b ? a : b }

export function normalizeHexString (v: string): string {
